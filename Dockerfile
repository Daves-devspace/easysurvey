...
# Copy Python runtime packages only (no cache, no unnecessary binaries)
...
# Create directories for static and media with proper permissions
RUN mkdir -p /app/static /app/media && chmod -R 755 /app
