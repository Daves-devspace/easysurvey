...
for (var t = 0; t < tc.length; t++) {
  ...
  prod_like.addEventListener("change", function (event) {
    if (event.currentTarget.checked) {
      ...
      prod_like.parentNode
        .querySelector(".pc-like")
        .classList.add("pc-like-animate");
      setTimeout(function () {
        try {
...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute("src", "../assets/images/plotsync.png");
}
...
function layout_change_default() {
  ...
  var btn_control = document.querySelector(
    '.theme-layout .btn[data-value="default"]',
  );
  if (btn_control) {
...
function font_change(name) {
  ...
  document
    .querySelector("body")
    .setAttribute("style", 'font-family:"' + name + '", sans-serif');
  if (name == "Public Sans") {
    name = "Public-Sans";
  }
  ...
  if (control) {
    document
      .querySelector(".fontpreset-color > a.active")
      .classList.remove("active");
    document
      .querySelector(".fontpreset-color > a[data-value='" + name + "']")
...
function preset_change(value) {
  document
    ...
    .setAttribute("data-pc-preset", value);
  var control = document.querySelector(".pct-offcanvas");
  if (control) {
    document
      ...
      .classList.remove("active");
    document
      .querySelector(".preset-color > a[data-value='" + value + "']")
      .classList.add("active");
  }
}
...
function layout_rtl_change(value) {
  ...
  if (value == "true") {
    ...
    document
      .getElementsByTagName("body")[0]
      .setAttribute("data-pc-direction", "ltr");
...
function layout_change(layout) {
  ...
  document
    .getElementsByTagName("body")[0]
    .setAttribute("data-pc-theme", layout);

  var btn_control = document.querySelector(
    '.theme-layout > a[data-value="default"]',
  );
  if (btn_control) {
  ...
  if (layout == "dark") {
    ...
    if (document.querySelector(".pc-sidebar .m-header .logo-lg")) {
      document
        ...
        .setAttribute("src", "../assets/images/plotsync.png");
    }
    ...
    if (control) {
      document
        .querySelector(".theme-layout > a.active")
        .classList.remove("active");
      document
...
function change_box_container(value) {
  if (document.querySelector(".pc-content")) {
    if (value == "true") {
      ...
      if (control) {
        document
          .querySelector(".theme-container > a.active")
          .classList.remove("active");
        document
          .querySelector(".theme-container > a[data-value='true']")
          .classList.add("active");
      }
    } else {
      ...
      if (control) {
        document
          ...
          .classList.remove("active");
        document
          .querySelector(".theme-container > a[data-value='false']")
          .classList.add("active");
      }
    }
  }
