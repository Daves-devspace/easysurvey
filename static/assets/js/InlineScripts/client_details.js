...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (urlParams.has("service") || urlParams.has("start_date") || urlParams.has("end_date")) {
    ...
    filterForm?.addEventListener("submit", function (e) {
        ...
        fetch(`${window.location.pathname}?${params}`, {
            ...
            .then(json => {
                ...
                data.forEach((p, i) => {
                    let badgeClass = 'bg-danger', badgeText = 'Not Paid';
                    if (p.payment_status === 'Fully Paid') {
                        badgeClass = 'bg-success'; badgeText = 'Fully Paid';
                    } else if (p.payment_status === 'Partially Paid') {
                        badgeClass = 'bg-warning text-dark'; badgeText = 'Partially Paid';
                    }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    serviceSelect.addEventListener("change", function () {
        ...
        if (selectedOption && selectedOption.value) {
            ...
            nameSpan.innerText = selectedOption.label || selectedOption.textContent.trim();
            ...
            nameSpan.innerText = totalSpan.innerText = paidSpan.innerText = pendingSpan.innerText = '';
        }
    });
});
    ...
    function setupDetailButton() {
        if (detailBtn) {
            detailBtn.addEventListener('click', () => {
                if (!currentUrl) return alert('Please click a row’s Preview button first.');
